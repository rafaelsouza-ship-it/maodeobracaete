        ...
        <div className="p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              className={`w-full bg-[#155645] text-white font-semibold py-3 px-4 rounded-lg transition-colors shadow-lg border-b-4 border-[#0e3a2f] active:border-b-0 active:translate-y-1 flex items-center justify-center space-x-2 ${isSubmitting ? 'opacity-70 cursor-not-allowed' : 'hover:bg-[#104033]'}`}
            >
              {isSubmitting ? (
                <>
